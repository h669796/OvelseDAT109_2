...
class BilUtleieSelskapTest {
    ...
    void opprettUtleieKontrakt() {
        ...
        UtleieKontrakt kontrakt = selskap.opprettUtleieKontrakt(reservasjon, kunde, bil, henteDato, returDato, 100, "1111111", LocalDate.now().plusYears(1), adresse);
        assertNotNull(kontrakt, "Utleiekontrakten bør opprettes");

        //opprette kontrakt hvis ikke bil er ledig
        bil.setStatus(false);
        UtleieKontrakt ugyldigKontrakt = selskap.opprettUtleieKontrakt(reservasjon, kunde, bil, henteDato, returDato, 100, "1111111", LocalDate.now().plusYears(1), adresse);
    ...
    void returAvBil() {
        ...
        //opprett kontrakten
        UtleieKontrakt kontrakt = selskap.opprettUtleieKontrakt(reservasjon, kunde, bil, start, slutt, 100, "1111111", LocalDate.now().plusYears(1), adresse);
